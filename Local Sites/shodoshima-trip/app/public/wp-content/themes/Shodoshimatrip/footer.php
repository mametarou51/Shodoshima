<footer class="wrapper">
    ...
    <div class="list-wrapper">
        ...
        <ul class="footer-list">
            ...
            <li><a href="<?php echo esc_url(get_permalink(68)); ?>">オリーブラーメン</a></li>
            <li><a href="<?php echo esc_url(get_permalink(68)); ?>">オリーブそうめん</a></li>
            <li><a href="<?php echo esc_url(get_permalink(68)); ?>">オリーブ牛ステーキ</a></li>
            <li><a href="<?php echo esc_url(get_permalink(68)); ?>">手延べそうめん</a></li>
        </ul>
    </div>
